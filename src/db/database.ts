...
import { BodyMetric, DailyReadiness, Exercise, ExerciseInstance, Macrocycle, Mesocycle, Microcycle, ScheduledSession, Session, TemplateExercise, WorkingSet, WorkoutTemplate } from './models';
...
export const database = new Database({
  adapter,
  modelClasses: [Exercise, Session, ExerciseInstance, WorkingSet, WorkoutTemplate, TemplateExercise, ScheduledSession, Macrocycle, Mesocycle, Microcycle, BodyMetric, DailyReadiness],
});
